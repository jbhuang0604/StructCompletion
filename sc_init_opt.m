...
% === Patch size ===
optS.pSize = 9;                        % Patch size (odd number)
...
optS.wDist = 2.^linspace(1, 1, optS.numPyrLvl); % Weighting parameters for patch match
...
optS.minScale = 0.25;                   % Mininum scale variation
optS.maxScale = 4;                     % Maximum scale variation
...
optS.numIter    = 50;                  % The initial iteration number, large hole might require
                                       % more iterations
...
optS.lambdaProx   = 0.1;                % Weighting parameters for proximity cost
optS.proxThres    = 0.0;

optS.lambdaReg    = -0.01;             % Weighting parameters for encouraging 
...
optS.rsThres = 0.0;                    % Random sampling threshold for early termination
optS.voteUpdateW = 25;                 % Smaller number for quick voting update
...
optA.numVP = 4; 
% Fixed density for frontal parallel plane
